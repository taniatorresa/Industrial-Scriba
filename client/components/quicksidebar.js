                  ...
                  <div className="page-quick-sidebar-chat-users" data-rail-color="#ddd" data-wrapper-class="page-quick-sidebar-list">
                    ...
                    <ul className="media-list list-items">
                      <li className="media">
                        ...
                        <img className="media-object" src="/assets/img/avatar3.jpg" alt="..." />
                      ...
                      <li className="media">
                        <img className="media-object" src="/assets/img/avatar1.jpg" alt="..." />
                        <div className="media-body">
                      ...
                      <li className="media">
                        ...
                        <img className="media-object" src="/assets/img/avatar4.jpg" alt="..." />
                        <div className="media-body">
                      ...
                      <li className="media">
                        <img className="media-object" src="/assets/img/avatar2.jpg" alt="..." />
                        <div className="media-body">
                    ...
                    <ul className="media-list list-items">
                      <li className="media">
                        ...
                        <img className="media-object" src="/assets/img/avatar6.jpg" alt="..." />
                        <div className="media-body">
                      ...
                      <li className="media">
                        ...
                        <img className="media-object" src="/assets/img/avatar7.jpg" alt="..." />
                        <div className="media-body">
                      ...
                      <li className="media">
                        <img className="media-object" src="/assets/img/avatar8.jpg" alt="..." />
                        <div className="media-body">
                      ...
                      <li className="media">
                        ...
                        <img className="media-object" src="/assets/img/avatar9.jpg" alt="..." />
                        <div className="media-body">
                      ...
                      <li className="media">
                        <img className="media-object" src="/assets/img/avatar10.jpg" alt="..." />
                        <div className="media-body">
                      ...
                      <li className="media">
                        ...
                        <img className="media-object" src="/assets/img/avatar11.jpg" alt="..." />
                        <div className="media-body">
                    ...
                    <div className="page-quick-sidebar-chat-user">
                      ...
                      <div className="page-quick-sidebar-chat-user-messages">
                        <div className="post out">
                          <img className="avatar" alt src="/assets/img/avatar3.jpg" />
                        ...
                        <div className="post in">
                          <img className="avatar" alt src="/assets/img/avatar2.jpg" />
                          <div className="message">
                            <span className="arrow" />
                      ...
                      <div className="page-quick-sidebar-chat-user-form">
                        <div className="input-group">
                          <input className="form-control" placeholder="Type a message here..." type="text" />
                  ...
                  <div className="page-quick-sidebar-settings-list">
                    ...
                    <ul className="list-items borderless">
                      <li> Enable Notifications
                        <input className="make-switch" defaultChecked data-size="small" data-on-color="success" data-on-text="ON" data-off-color="default" data-off-text="OFF" type="checkbox" /> </li>
                      <li> Allow Tracking
                        <input className="make-switch" data-size="small" data-on-color="info" data-on-text="ON" data-off-color="default" data-off-text="OFF" type="checkbox" /> </li>
                      <li> Log Errors
                        <input className="make-switch" defaultChecked data-size="small" data-on-color="danger" data-on-text="ON" data-off-color="default" data-off-text="OFF" type="checkbox" /> </li>
                      <li> Auto Sumbit Issues
                        <input className="make-switch" data-size="small" data-on-color="warning" data-on-text="ON" data-off-color="default" data-off-text="OFF" type="checkbox" /> </li>
                    ...
                    <ul className="list-items borderless">
                      ...
                      <li> Notify On SMTP Error
                        <input className="make-switch" defaultChecked data-size="small" data-on-color="warning" data-on-text="ON" data-off-color="default" data-off-text="OFF" type="checkbox" /> </li>
                    </ul>
